...
export const movie = (state = initialState, action) => {
	...
	switch (type) {
		case GET_MOVIES_BY_SEARCH_QUERY:
			return {
				...state, searchQuery: payload.search, sortBy: payload.sortBy, isFetching: true
			}
			case GET_MOVIES_BY_SEARCH_QUERY_SUCCESS:
				return {
					...state, movies: payload.movies, isFetching: false
				}
				...
				case SET_SEARCH_FILTER:
					...
					case SET_SORT_FILTER:
						...
						case GET_MOVIE_DETAILS_BY_ID:
							return {
								...state, id: payload.id, isFetching: true
							}
							case GET_MOVIE_DETAILS_BY_ID_SUCCESS:
								return {
									...state, movie: payload.movie, isFetching: false
								}
